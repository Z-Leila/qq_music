// var fs=require('fs');
// var minling=require('child_process');
// var files=fs.readdirSync('./music/');
// var result=[];
// files.forEach(function(v){
// 	var data=minling.execSync('ffprobe -v quiet -print_format json -show_format ./music/'+v);
// 	result.push(JSON.parse(data));
// })
// fs.writeFile('./database.json',JSON.stringify(result,null,4));
